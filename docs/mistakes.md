...
- **해결**: `globals.css`에서 우리 placeholder 하위 `.ezoic-ad` margin을 0으로 덮어쓰고, 예약을 100 → 118(320×100 + 신고 줄 18)로 보정. "AD" 라벨은 자기 줄(19px)을 없애고 신고 줄 왼쪽에 절대 배치. 검사 스크립트는 `span.ezoic-ad`(margin 15px CSS 포함) + `.reportline`까지 흉내 내도록 수정
