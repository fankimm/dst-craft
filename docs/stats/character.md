...
> usage 태그: [character]=캐릭터 전용, [skilltree]=스킬트리 연동
...
- NIGHTMARE 연료 720, 스펠 1회당 -36 연료 (최대 20회)
- 4종 스펠: 일꾼 / 수호자 / 덫 / 기둥
- 스펠 시 정신력 -15 (일꾼·수호자 제외)
- 재료: papyrus×2 + nightmarefuel×2 + 체력 50
- usage: [character]Maxwell 그림자 복사본 소환 통합 아이템
- 소스: prefabs/waxwelljournal.lua, tuning.lua

> shadow*_builder 4종 DEPRECATED 항목 (shadowdigger / shadowduelist / shadowlumber / shadowminer):
> waxwelljournal로 통합됨. 기존 재료(nightmarefuel×2 + 도구×1)·정신력 소모(20~35%) 수치는 구버전.
...
- 소스: prefabs/walter_slingshot_ammo.lua, tuning.lua
...
- 소스: prefabs/walter_slingshot.lua

## slingshotammo_container — 탄환 파우치
- 6슬롯 탄약 전용 가방
- usage: [character]Walter 탄약 휴대 용량 확장
- 소스: prefabs/walter_slingshot_ammo.lua

## walter_rope — 밧줄
- 풀 2개로 밧줄 제작 (일반은 3개)
- usage: [character]Walter 전용 효율 레시피
- 소스: prefabs/walter.lua

## woby_treat — 워비 간식
- 건조 괴물고기 1개 → 2개 생산
- 워비 허기 3배 회복
- usage: [character]Walter 전용 워비 먹이
- 소스: prefabs/woby.lua
...
- 나이 8년 역전 + HP 20 회복
- 쿨다운: 120초
- usage: [character]Wanda 나이 관리 + 회복
- 소스: prefabs/wanda_pocketwatches.lua
...
- 쿨다운: 480초 (1일)
- 지하 ↔ 지상 이동 가능
- usage: [character]Wanda 장거리 이동
- 소스: prefabs/wanda_pocketwatches.lua

## pocketwatch_revive — 회생의 시계
- 자가 부활 (유령 → haunting) + 타인 부활
- 쿨다운: 240초
- usage: [character]Wanda 부활 수단
- 소스: prefabs/wanda_pocketwatches.lua

## pocketwatch_warp — 역행의 시계
- 과거 위치로 순간이동 (나이별 거리: young 8 / normal 4 / old 2)
- 쿨다운: 2초
- usage: [character]Wanda 단거리 회피기
- 소스: prefabs/wanda_pocketwatches.lua
...
- 배치형, 조리 속도 20% 빠름 (cooktimemult 0.8)
- 해머 2회로 해체
- usage: [character]Warly 이동식 요리솥
- 소스: prefabs/warly.lua

## portableblender_item — 휴대용 제분기
- 배치형, FOODPROCESSING 프로토타이퍼
- 해머 2회로 해체
- usage: [character]Warly 전용 식재료 가공기
- 소스: prefabs/warly.lua

## portablespicer_item — 휴대용 양념기
- 배치형, 양념 + 요리
- 해머 2회로 해체
- usage: [character]Warly 양념 적용 요리
- 소스: prefabs/warly.lua

## spicepack — 요리사 파우치
- BODY 슬롯 가방 6칸
- 부패 방지
- usage: [character]Warly 재료/양념 보관
- 소스: prefabs/warly.lua
...
- usage: [character]Wormwood 전용 (Wathgrithr 데이터에 포함)
- 소스: prefabs/wathgrithr.lua, tuning.lua
...
| battlesong_instant_revive | 전사의 레프리제 | 유령 2명 부활, 영감 83.3, 쿨 150초, [skilltree] |
| battlesong_lunaraligned | 계몽의 자장가 | 달 피해 -10% + 그림자에 +5%, [skilltree] |
| battlesong_shadowaligned | 어둠의 애가 | 그림자 피해 -10% + 달에 +5%, [skilltree] |

- 소스: prefabs/wathgrithr.lua, tuning.lua

## saddle_wathgrithr — 전사의 안장
- uses: 6, 이동속도: 1.3, 피해 +5, 흡수 40%
- usage: [character]Wathgrithr, [skilltree]
- 소스: prefabs/wathgrithr.lua
...
- usage: [character]Webber 거미 변이 아이템
- 소스: prefabs/webber.lua

## spider_healer_item — 치료액 방울
- Webber HP +8
- 주변 거미 HP +80 (반경 5)
- usage: [character]Webber 자신 + 거미 회복
- 소스: prefabs/webber.lua

## spidereggsack — 거미 알
- 설치 시 거미굴 생성
- 스택 10, 연료 180
- usage: [character]Webber 거미굴 설치
- 소스: prefabs/webber.lua
...
- 소환/귀환 토글, 스펠 휠 명령, ghostlyelixirable
- usage: [character]Wendy 아비게일 소환 도구
- 소스: prefabs/wendy.lua

## ghostflowerhat — 망령 화관
- dapperness: +0.056, perish: 4800 (10일)
- 엘릭서 효과 적용
- usage: [character]Wendy, [skilltree]
- 소스: prefabs/wendy.lua

## elixir_container — 소풍용 관짝
- 3×3 컨테이너
- usage: [character]Wendy 엘릭서 보관
- 소스: prefabs/wendy.lua
...
| ghostlyelixir_lunar | 광명의 분노 | 차원 피해 +10 (게스탈트 +100), 120초 | — ([skilltree] 슈퍼엘릭서) |
| ghostlyelixir_shadow | 저주의 원념 | 그림자 효과, 480초 | — ([skilltree] 슈퍼엘릭서) |

- 소스: prefabs/wendy.lua, tuning.lua
...
- 부활 구조물, HP -40 연동 비용
- usage: [character]Wendy 전용 부활 제단
- 소스: prefabs/wendy.lua
...
## balloon — 풍선
- 핸드 슬롯 장착, 9가지 모양 랜덤
- usage: [character]Wes 퍼포먼스 아이템
- 소스: prefabs/wes.lua

## balloonparty — 파티 풍선
- 터뜨리면 정신력 회복 (파티 규모 비례, 2초 틱)
- usage: [character]Wes 정신력 회복
- 소스: prefabs/wes.lua

## balloonspeed — 날쌘돌이 풍선
- 이동속도 1.0 → 1.3 (연료 비례), 연료: 120초
- usage: [character]Wes 이동 버프 풍선
- 소스: prefabs/wes.lua
...
- BOOKCRAFT 프로토타이퍼
- usage: [character]Wickerbottom 책 보관 및 내구 회복
- 소스: prefabs/wickerbottom.lua

## 책 테이블 (공통: 읽기 정신력 -33, [character]Wickerbottom)

| ID | 한글명 | uses | 특수 비용 | 효과 |
|---|---|---|---|---|
| book_bees | 양봉비책 | 3 | — | beeguard 2마리 소환 (최대 16) |
...
| book_light | 영원의 빛 | 3 | 정독 +33 | booklight 240초 소환 |
| book_light_upgraded | 영원의 빛 개정판 | 5 | 정독 +50 | booklight 960초 소환 |
| book_moon | 월광의 서 | 3 | 읽기 -50 | 보름달 강제 |
| book_rain | 실전 기우제 | 5 | 정독 +33 | 비 토글 + 농경 수분 100 |
| book_research_station | 만물의 백과사전 | 3 | 정독 +33 | 반경 16 기술 보너스 (SCIENCE+2, MAGIC+2, SEAFARING+2) |
| book_silviculture | 응용 조림학 | 5 | — | 반경 30 나무 전체 성장 (레시피 없음, bookstation 획득) |
...
- 소스: prefabs/wickerbottom.lua, tuning.lua
...
- 연료: 2400 (실효 15일)
- 광기 시 bernie_active 변신 (HP 1000, 공격 50)
- usage: [character]Willow 광기 수호 아이템
- 소스: prefabs/willow.lua, tuning.lua

## lighter — 윌로우의 라이터
- 무기 피해: 17, 점화 확률: 50%
- 연료: 600 (1.25일), 조리 가능
- usage: [character]Willow 점화 + 근접 무기
- 소스: prefabs/willow.lua
...
| 단계 | ID | 한글명 | 변환 |
|---|---|---|---|
| alchemy_1 | transmute_log | 잔가지 3 → 나무 | log |
| alchemy_1 | transmute_twigs | 나무 1 → 잔가지 2 | twigs |
| alchemy_2 | transmute_bluegem | 붉은 2 → 푸른 | bluegem |
| alchemy_2 | transmute_redgem | 푸른 2 → 붉은 | redgem |
| alchemy_2 | transmute_purplegem | 푸른 + 붉은 → 보라 | purplegem |
| alchemy_3 | transmute_flint | 돌 3 → 부싯돌 | flint |
| alchemy_3 | transmute_rocks | 부싯돌 2 → 돌 | rocks |
| alchemy_4 | transmute_meat | 작은고기 3 → 고기 | meat |
| alchemy_4 | transmute_smallmeat | 고기 1 → 작은고기 2 | smallmeat |
| alchemy_5 | transmute_orangegem | 보라 3 → 주황 | orangegem |
| alchemy_5 | transmute_yellowgem | 주황 3 → 노랑 | yellowgem |
| alchemy_6 | transmute_greengem | 노랑 3 → 초록 | greengem |
| alchemy_6 | transmute_opalpreciousgem | 6보석 각 1 → 무지개 | opalpreciousgem |
| alchemy_7 | transmute_goldnugget | 초석 3 → 금 | goldnugget |
| alchemy_7 | transmute_nitre | 금 2 → 초석 | nitre |
| alchemy_8 | transmute_marble | 석재 2 → 대리석 | marble |
| alchemy_8 | transmute_cutstone | 대리석 1 → 석재 | cutstone |
| alchemy_8 | transmute_moonrocknugget | 대리석 2 → 월석 | moonrocknugget |
| alchemy_9 | transmute_beardhair | 비팔로털 2 → 수염 | beardhair |
| alchemy_9 | transmute_beefalowool | 수염 2 → 비팔로털 | beefalowool |
| alchemy_10 | transmute_boneshard | 사냥개이빨 2 → 뼛조각 | boneshard |
| alchemy_10 | transmute_houndstooth | 뼛조각 2 → 사냥개이빨 | houndstooth |
| alchemy_10 | transmute_poop | 부패물 6 → 거름 | poop |
| allegiance_shadow | transmute_horrorfuel | 공포석 1 → 순수한 공포 2 | horrorfuel |
| allegiance_shadow | transmute_dreadstone | 순수한 공포 3 → 공포석 | dreadstone |
| allegiance_shadow | transmute_nightmarefuel | 순수한 공포 1 → 악몽 연료 2 | nightmarefuel |
| allegiance_lunar | transmute_purebrilliance | 충전된 달 파편 3 → 순수한 광휘 | purebrilliance |
| allegiance_lunar | transmute_moonglass_charged | 순수한 광휘 1 → 충전된 달 파편 2 | moonglass_charged |

- usage: [character]Wilson [skilltree] 연금술 변환
- 소스: prefabs/wilson.lua, tuning.lua
...
- usage: [character]Wolfgang 운동 + 전투 무기
- 소스: prefabs/wolfgang.lua, tuning.lua

## mighty_gym — 울끈불끈 체육관
- 구조물, 중량 품질별 운동 효율: LOW 4 / MED 6.67 / HIGH 10 mightiness/타
- 허기 소모: 4 / 11 / 22
- usage: [character]Wolfgang 강화 훈련
- 소스: prefabs/wolfgang.lua

## wolfgang_whistle — 지도용 호루라기
- 코칭 버프 ×2, 영감 소요 7초, 버프 지속 10초
- usage: [character]Wolfgang 팀 코칭
- 소스: prefabs/wolfgang.lua
...
## livinglog — 생목
- 자원, 연료: 45, 배 수리: 37.5
- usage: [character]Woodie 전용 자원 (Woodie 변신 시 획득 가능)
- 소스: prefabs/woodie.lua
...
- Wormwood 치유: 2HP/2초
- usage: [character]Wormwood 농업 비료 + 자가 회복
- 소스: prefabs/wormwood.lua, tuning.lua

## mosquitobomb — 목이탄
- 피해: 59.5, 범위: 3, 모기 4마리 소환 (스킬 보유 시 6)
- usage: [character]Wormwood 투척 폭탄
- 소스: prefabs/wormwood.lua

## mosquitofertilizer — 왱비료
- 비료: 300, 토양 주기: 10, 영양분: {12, 12, 12}
- usage: [character]Wormwood 소형 비료
- 소스: prefabs/wormwood.lua

## mosquitomermsalve — 피주사
- Wurt HP +16, 어인 HP +100
- usage: [character]Wormwood (Wurt 연계 치료)
- 소스: prefabs/wormwood.lua

## mosquitomusk — 꼬마 따끔이
- 모기 비공격 (평화 효과), 부패: 3840 (8일)
- usage: [character]Wormwood 모기 중립화
- 소스: prefabs/wormwood.lua

## wormwood_berrybush — 베리 덤불
- 설치 식물, 3일 주기, 3~4회 수확
- usage: [character]Wormwood 식물 설치
- 소스: prefabs/wormwood.lua

## wormwood_berrybush2 — 베리 덤불 변종
- 동일 (wormwood_berrybush와 같은 사이클)
- usage: [character]Wormwood
- 소스: prefabs/wormwood.lua
...
- HP: 300, 아이플랜트 소환
- usage: [character]Wormwood 방어 식물
- 소스: prefabs/wormwood.lua

## wormwood_carrat — 캐럿
- HP: 25, 수명: 3일, 최대 4마리
- usage: [character]Wormwood 식물 크리처
- 소스: prefabs/wormwood.lua

## wormwood_lightflier — 전구근
- HP: 25, 수명: 2.5일, 최대 6마리, 발광
- usage: [character]Wormwood 조명 식물 크리처
- 소스: prefabs/wormwood.lua

## wormwood_fruitdragon — 용과
- HP: 600 (스킬 보유 시 900), 피해: 40, 수명: 2일, 최대 2마리
- usage: [character]Wormwood 전투 식물 크리처
- 소스: prefabs/wormwood.lua
...
- 부활 아이템, 부패: 10일
- usage: [character]Wortox, [skilltree]wortox_lifebringer_3
- 소스: prefabs/wortox.lua

## wortox_souljar — 영혼 단지
- 영혼 보관, 30초마다 누출 (스킬 보유 시 중지)
- 영혼 최대 +5
- usage: [character]Wortox 영혼 저장
- 소스: prefabs/wortox.lua
...
## merm_armory — 무기곩
- 어인 갑옷·모자 지급, 해머 4회
- usage: [character]Wurt 어인 군사 장비
- 소스: prefabs/wurt.lua

## merm_armory_upgraded — 상급 무기곩
- 상급 모자 지급
- usage: [character]Wurt
- 소스: prefabs/wurt.lua
...
- 어인 1마리 소환, 재생: 2일
- usage: [character]Wurt 어인 소환
- 소스: prefabs/wurt.lua

## mermthrone_construction — 왕위 제작 키트
- 건설 재료 투입 → 어인 왕 소환
- usage: [character]Wurt 어인 왕 소환
- 소스: prefabs/wurt.lua

## mermwatchtower — 어인 욣새
- 경비병 소환, 재생: 0.5일 (겨울 ×12)
- usage: [character]Wurt 어인 경비 초소
- 소스: prefabs/wurt.lua

## offering_pot — 공용 다시마 그릇
- 머미 소집 + 급식, 범위: 7
- usage: [character]Wurt 어인 집결 + 식사
- 소스: prefabs/wurt.lua
...
| wx78module_movespeed2 | 초가속 회로 | 2 | movespeed와 동일 함수 |
...
- usage: [character]WX-78 슬롯 장착 강화 모듈
- 소스: prefabs/wx78.lua, tuning.lua
