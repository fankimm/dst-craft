...
DEADLINES=$(
  cat <<'EOF'
done:2026-09-08|Ad Manager 주소확인 PIN 재발송 요청 가능 최초일|미발동 — 8/31에 우편이 먼저 도착해 재발송이 필요 없었다
done:2026-10-02|Ad Manager 주소확인 PIN 입력 마감|2026-08-31 인증 완료 (본인 인증·주소 확인 모두 '완료됨'). 32일 남기고 해소
