...
export function Footer() {
  return (
    <footer className="mt-auto flex flex-col items-center gap-1.5 px-4 pt-2 text-xs text-muted-foreground/60 border-t border-border/50" style={{ paddingBottom: "env(safe-area-inset-bottom, 0.25rem)" }}>
