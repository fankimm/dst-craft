        ...
        <section>
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="rounded-lg border border-border bg-surface px-3 py-3 text-center">
              <img src="/images/ui/health.webp" alt={lang === "ko" ? "체력" : "Health"} className="size-5 object-contain mx-auto mb-1" loading="lazy" />
            ...
            <div className="rounded-lg border border-border bg-surface px-3 py-3 text-center">
              <img src="/images/ui/hunger.webp" alt={lang === "ko" ? "허기" : "Hunger"} className="size-5 object-contain mx-auto mb-1" loading="lazy" />
            ...
            <div className="rounded-lg border border-border bg-surface px-3 py-3 text-center">
              <img src="/images/ui/sanity.webp" alt={lang === "ko" ? "정신력" : "Sanity"} className="size-5 object-contain mx-auto mb-1" loading="lazy" />
