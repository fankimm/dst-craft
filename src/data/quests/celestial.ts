...
export const celestialQuest: Quest = {
  ...
  steps: [
    ...
    },
    {
      ...
      descKo: "인간형 페이즈 — 광역 레이저와 분신 패턴.",
      descEn: "Humanoid phase — beam and clone attacks.",
    ...
    },
    {
      ...
      descKo: "사족 보행 페이즈 — 가시 분출과 돌진.",
      descEn: "Quadruped phase — spike fields and charges.",
    ...
    },
    {
      ...
      descKo: "거대 구체 페이즈 — 회전 빔과 트랩 패턴. 처치 시 계몽의 조각 보상.",
      descEn: "Giant orb phase — rotating beams and traps. Drops Enlightened Shards.",
