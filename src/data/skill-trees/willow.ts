...
export const willow: CharacterSkillTree = {
  ...
  nodes: [
    ...
    { id: "willow_allegiance_lock_1b", group: "allegiance", pos: [180, 174], root: true, lockType: { type: "no_opposing_faction", faction: "shadow" }, connects: ["willow_allegiance_shadow_fire", "willow_allegiance_shadow_bernie"], tags: ["allegiance", "lock"] },
    ...
    { id: "willow_allegiance_shadow_fire", group: "allegiance", pos: [214, 109], icon: "willow_allegiance_shadow_fire", locks: ["willow_allegiance_lock_1", "willow_allegiance_lock_1b", "willow_allegiance_lock_3"], tags: ["allegiance", "shadow_favor"] },
    { id: "willow_allegiance_shadow_bernie", group: "allegiance", pos: [146, 109], icon: "willow_allegiance_shadow_bernie", locks: ["willow_allegiance_lock_1", "willow_allegiance_lock_1b", "willow_allegiance_lock_2"], tags: ["allegiance", "shadow_favor"] },
    ...
    { id: "willow_allegiance_lock_4b", group: "allegiance", pos: [180, 73], root: true, lockType: { type: "no_opposing_faction", faction: "lunar" }, connects: ["willow_allegiance_lunar_fire", "willow_allegiance_lunar_bernie"], tags: ["allegiance", "lock"] },
    ...
    { id: "willow_allegiance_lunar_fire", group: "allegiance", pos: [214, 8], icon: "willow_allegiance_lunar_fire", locks: ["willow_allegiance_lock_4", "willow_allegiance_lock_4b", "willow_allegiance_lock_5"], tags: ["allegiance", "lunar_favor"] },
    { id: "willow_allegiance_lunar_bernie", group: "allegiance", pos: [146, 8], icon: "willow_allegiance_lunar_bernie", locks: ["willow_allegiance_lock_4", "willow_allegiance_lock_4b", "willow_allegiance_lock_6"], tags: ["allegiance", "lunar_favor"] },
  ],
};
