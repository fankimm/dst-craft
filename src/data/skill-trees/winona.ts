...
export const winona: CharacterSkillTree = {
  ...
  nodes: [
    ...
    { id: "winona_portable_structures_lock", group: "midshelf", pos: [0, 85], root: true, connects: ["winona_catapult_volley_1", "winona_catapult_boost_1"], tags: ["lock"] },
    ...
    // ── Mid Shelf Lock ──
    { id: "winona_midshelf_lock", group: "midshelf", pos: [-220, 135], root: true, connects: ["winona_shadow_1", "winona_charlie_1", "winona_lunar_1", "winona_wagstaff_1"], tags: ["lock"] },
    ...
    { id: "winona_shadow_3_lock", group: "charlie", pos: [-60, 165], root: true, tags: ["lock"] },
    ...
    { id: "winona_charlie_2_lock", group: "charlie", pos: [-210, 165], root: true, tags: ["lock"] },
    ...
    { id: "winona_lunar_3_lock", group: "wagstaff", pos: [60, 165], root: true, tags: ["lock"] },
    ...
    { id: "winona_wagstaff_2_lock", group: "wagstaff", pos: [210, 165], root: true, tags: ["lock"] },
