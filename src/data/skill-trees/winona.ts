...
export const winona: CharacterSkillTree = {
  ...
  nodes: [
    ...
    // In-game: activated[winona_portable_structures] AND CountTags("lowshelf") > 2
    { id: "winona_portable_structures_lock", group: "midshelf", pos: [0, 85], root: true, connects: ["winona_catapult_volley_1", "winona_catapult_boost_1"], lockType: { type: "compound", required_skills: ["winona_portable_structures"], tag_counts: { tags: ["lowshelf"], count: 3 } }, tags: ["midshelf", "lock"] },
    ...
    // ── Mid Shelf Lock ──
    // In-game: CountTags("lowshelf") + CountTags("midshelf") > 5  (i.e. ≥ 6)
    { id: "winona_midshelf_lock", group: "midshelf", pos: [-220, 135], root: true, connects: ["winona_shadow_1", "winona_charlie_1", "winona_lunar_1", "winona_wagstaff_1"], lockType: { type: "compound", tag_counts: { tags: ["lowshelf", "midshelf"], count: 6 } }, tags: ["midshelf", "lock"] },
    ...
    // In-game: activated[winona_portable_structures] AND activated[winona_shadow_2]
    { id: "winona_shadow_3_lock", group: "charlie", pos: [-60, 165], root: true, lockType: { type: "compound", required_skills: ["winona_portable_structures", "winona_shadow_2"] }, tags: ["charlie", "lock"] },
    ...
    // In-game: activated[winona_charlie_1] AND NOT activated[winona_wagstaff_2]
    { id: "winona_charlie_2_lock", group: "charlie", pos: [-210, 165], root: true, lockType: { type: "compound", required_skills: ["winona_charlie_1"], excluded_skills: ["winona_wagstaff_2"] }, tags: ["charlie", "lock"] },
    ...
    // In-game: activated[winona_portable_structures] AND activated[winona_lunar_2]
    { id: "winona_lunar_3_lock", group: "wagstaff", pos: [60, 165], root: true, lockType: { type: "compound", required_skills: ["winona_portable_structures", "winona_lunar_2"] }, tags: ["wagstaff", "lock"] },
    ...
    // In-game: activated[winona_wagstaff_1] AND NOT activated[winona_charlie_2]
    { id: "winona_wagstaff_2_lock", group: "wagstaff", pos: [210, 165], root: true, lockType: { type: "compound", required_skills: ["winona_wagstaff_1"], excluded_skills: ["winona_charlie_2"] }, tags: ["wagstaff", "lock"] },
