...
export const winona: CharacterSkillTree = {
  ...
  nodes: [
    ...
    { id: "winona_lowshelf_lock", group: "lowshelf", pos: [-220, 35], root: true, lockType: { type: "skill_count", tag: "lowshelf", count: 3 }, connects: ["winona_catapult_speed_1", "winona_catapult_aoe_1", "winona_battery_efficiency_1"], tags: ["lock"] },
    ...
    { id: "winona_portable_structures_lock", group: "midshelf", pos: [0, 85], root: true, connects: ["winona_catapult_volley_1", "winona_catapult_boost_1"], lockType: { type: "manual", desc_ko: "휴대성 스킬 습득 및 위쪽 선반의 스킬 해금 필요", desc_en: "Requires Portability skill and upper shelf skills unlocked" }, tags: ["lock"] },
    ...
    // ── Mid Shelf Lock ──
    { id: "winona_midshelf_lock", group: "midshelf", pos: [-220, 135], root: true, connects: ["winona_shadow_1", "winona_charlie_1", "winona_lunar_1", "winona_wagstaff_1"], lockType: { type: "manual", desc_ko: "휴대성 스킬 습득 시 해금", desc_en: "Requires Portability skill" }, tags: ["lock"] },
    ...
    { id: "winona_shadow_3_lock", group: "charlie", pos: [-60, 165], root: true, lockType: { type: "manual", desc_ko: "휴대성 스킬 및 순수한 공포 발전기 스킬 습득 시 해금", desc_en: "Requires Portability + G.E.M.erator skills" }, tags: ["lock"] },
    ...
    { id: "winona_charlie_2_lock", group: "charlie", pos: [-210, 165], root: true, lockType: { type: "manual", desc_ko: "급속충전 스킬 습득 시 해금", desc_en: "Requires Rapid Recharge skill" }, tags: ["lock"] },
    ...
    { id: "winona_lunar_3_lock", group: "wagstaff", pos: [60, 165], root: true, lockType: { type: "manual", desc_ko: "휴대성 스킬 및 광휘 발G.E.M.기 스킬 습득 시 해금", desc_en: "Requires Portability + Brightstone G.E.M.erator skills" }, tags: ["lock"] },
    ...
    { id: "winona_wagstaff_2_lock", group: "wagstaff", pos: [210, 165], root: true, lockType: { type: "manual", desc_ko: "와그스태프 협력 스킬 습득 시 해금", desc_en: "Requires Wagstaff Collaboration skill" }, tags: ["lock"] },
