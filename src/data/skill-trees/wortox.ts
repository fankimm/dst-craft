...
export const wortox: CharacterSkillTree = {
  ...
  nodes: [
    ...
    // ── Locks ──
    { id: "wortox_lifebringer_lock", group: "nice", pos: [-225, 106], root: true, lockType: { type: "skill_count", tag: "nice1", count: 5 }, tags: ["nice", "lock"] },
    { id: "wortox_soulprotector_lock", group: "nice", pos: [-175, 95], root: true, lockType: { type: "skill_count", tag: "nice1", count: 5 }, tags: ["nice", "lock"] },
    { id: "wortox_souldecoy_lock", group: "naughty", pos: [225, 106], root: true, lockType: { type: "skill_count", tag: "naughty1", count: 5 }, tags: ["naughty", "lock"] },
    { id: "wortox_thief_lock", group: "naughty", pos: [175, 95], root: true, lockType: { type: "skill_count", tag: "naughty1", count: 5 }, tags: ["naughty", "lock"] },
