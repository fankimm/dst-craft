...
const translations = {
  ko: {
    ...
    skills_gate_no_shadow: "그림자와 친해지지 마세요.",
    skills_gate_no_lunar: "달과 친해지지 마세요.",
  ...
  en: {
    ...
    skills_gate_skill_count: "{count} skills required",
    ...
    skills_gate_no_shadow: "Have no shadow affinity.",
    skills_gate_no_lunar: "Have no lunar affinity.",
