...
const translations = {
  ko: {
    ...
    station_wagpunk_workstation: "관념 조립기",
    station_vault_refiner: "성소 대장간",
    ...
    cooking_campfire: "구이/조리",
    cooking_dryingrack: "건조대",
    cooking_teashop: "진주네 찻집",
    cooking_raw: "생식 가능",
    cooking_teashop_level: "찻집 레벨",
    cooking_teashop_level_help: "펄 할머니 집 장식 점수에 따라 재료 수량 감소 (Lv1: <50점, Lv2: 50~74점, Lv3: ≥75점)",
    cooking_health: "체력",
    cooking_hunger: "허기",
    cooking_sanity: "정신력",
    cooking_perish: "유통기한",
    ...
    cookpot_category_favorites: "즐겨찾기",
    cookpot_category_recent: "최근",
    ...
    support_anonymous: "익명 후원자",
    support_thanks: "후원해주신",
    health_cost: "체력 소모",
    skill_tree_required: "스킬트리",
    station_required: "스테이션 필요",
    blueprint_required: "블루프린트 필요",
    sketch_required: "도면 필요",
    sketch_source: "도면 입수처",
    sculpt_results: "재료별 결과물",
    ...
    effect_dust_moth_food: "먼지 나방 먹이",
    effect_hunger_regen: "허기 재생",
    effect_tea_petals_buff: "정신력 +1/초 (45초)",
    effect_tea_petals_evil_buff: "정신력 -2/초 (60초)",
    effect_tea_foliage_buff: "광역 정신 데미지 -10% (3분)",
    effect_tea_tillweed_buff: "체력 +1/0.5초 (15초)",
    effect_tea_moon_tree_blossom_buff: "그림자 생물 위협 (3분)",
    effect_tea_forgetmelots_buff: "정신력 +2/초 (45초)",
    ...
    skins_filter_rarity: "희귀도",
    skins_filter_character: "캐릭터/카테고리",
    skins_filter_all: "전체",
    skins_filter_clear: "필터 초기화",
    skins_no_results: "검색 결과가 없습니다",
    skins_count: "개",
    skins_set_label: "세트",
    skins_release_group: "릴리즈 그룹",
    skins_base_prefab: "기본 아이템",
    skins_tags: "태그",
    skins_sort_rarity: "희귀도순",
    skins_sort_name: "이름순",
    skins_sort_release_new: "최신순",
    skins_sort_release_old: "오래된순",
    skins_section_characters: "캐릭터",
    skins_section_kinds: "종류",
    skins_kind_body: "본체 의상",
    skins_rarity_modifier_Woven: "직조",
    skins_rarity_modifier_CharacterModifier: "캐릭터",
    skins_rarity_modifier_Inspired: "영감",
    skins_rarity_modifier_Lustrous: "광택",
    rarity_Common: "일반",
    rarity_Classy: "고급",
    rarity_Spiffy: "특수",
    rarity_Distinguished: "정교",
    rarity_Elegant: "우아",
    rarity_Loyal: "충성",
    rarity_Timeless: "영원",
    rarity_Event: "이벤트",
    rarity_Reward: "보상",
    rarity_Character: "캐릭터",
    rarity_ProofOfPurchase: "구매보상",
    rarity_Resurrected: "부활",
    rarity_Complimentary: "기념",
    rarity_HeirloomClassy: "가보 고급",
    rarity_HeirloomSpiffy: "가보 특수",
    rarity_HeirloomDistinguished: "가보 정교",
    rarity_HeirloomElegant: "가보 우아",
    quests_header: "퀘스트 체크리스트",
    quests_subheader: "은둔자·연료직공·대변자·천상의 귀공자 진행. 체크는 이 기기에만 저장됩니다.",
    quests_reset: "초기화",
    quests_reset_confirm: "이 퀘스트의 모든 체크를 초기화할까요?",
    quests_reset_all: "전체 초기화",
    quests_reset_all_confirm: "모든 퀘스트의 체크를 초기화할까요?",
    console_item_spawn: "아이템 소환",
    console_entity_spawn: "엔티티 소환",
    console_search_items: "아이템 검색...",
    console_quantity: "갯수",
    console_copied: "클립보드에 복사됨",
    console_player: "캐릭터 상태",
    console_world: "월드 제어",
    console_server: "서버 관리",
    console_debug: "디버그",
    console_spawn_mode_give: "인벤토리",
    console_spawn_mode_spawn: "커서 위치",
    console_copy_command: "명령어 복사",
    console_show_command: "명령어 보기",
    skills_points: "습득",
    skills_learn: "습득",
    skills_unlearn: "해제",
    skills_locked: "잠금",
    skills_reset: "초기화",
    skills_requirements: "습득 조건",
    skills_unlocks_items: "해금 아이템",
    skills_select_character: "캐릭터 선택",
    skills_gate_skill_count: "스킬 {count}개를 습득하세요.",
    skills_gate_boss_fuelweaver: "고대의 연료직공을 찾아 쓰러뜨리세요.",
    skills_gate_boss_celestialchampion: "천상의 대변자를 찾아 쓰러뜨리세요.",
    skills_gate_no_shadow: "그림자 진영 스킬을 배우지 마세요.",
    skills_gate_no_lunar: "달 진영 스킬을 배우지 마세요.",
    skills_gate_total_skills: "스킬 {count}개를 습득하세요.",
    game_data_version: "게임 데이터 기준",
    game_data_release: "Release",
    game_data_updated: "갱신일",
    dev_menu: "개발자 메뉴",
  ...
  en: {
    ...
    station_wagpunk_workstation: "Notional Fabricator",
    station_vault_refiner: "Sanctum Smithy",
    ...
    cooking_campfire: "Roasted/Cooked",
    cooking_dryingrack: "Drying Rack",
    cooking_teashop: "Pearl's Tea Shop",
    cooking_raw: "Raw Food",
    cooking_teashop_level: "Shop Level",
    cooking_teashop_level_help: "Pearl's house decoration score lowers ingredient cost (Lv1: <50, Lv2: 50–74, Lv3: ≥75).",
    ...
    cookpot_category_favorites: "Favorites",
    cookpot_category_recent: "Recent",
    ...
    sketch_source: "Where to get the sketch",
    sculpt_results: "Result by material",
    ...
    effect_dust_moth_food: "Dust Moth Food",
    effect_hunger_regen: "Hunger Regen",
    effect_tea_petals_buff: "Sanity +1/sec (45s)",
    effect_tea_petals_evil_buff: "Sanity -2/sec (60s)",
    effect_tea_foliage_buff: "-10% Sanity Aura (3 min)",
    effect_tea_tillweed_buff: "Health +1/0.5s (15s)",
    effect_tea_moon_tree_blossom_buff: "Panics Shadow Creatures (3 min)",
    effect_tea_forgetmelots_buff: "Sanity +2/sec (45s)",
    ...
    skins_filter_rarity: "Rarity",
    skins_filter_character: "Character/Category",
    skins_filter_all: "All",
    skins_filter_clear: "Reset filters",
    skins_no_results: "No skins match your filters",
    skins_count: "skins",
    skins_set_label: "Set",
    skins_release_group: "Release",
    skins_base_prefab: "Base item",
    skins_tags: "Tags",
    skins_sort_rarity: "Rarity",
    skins_sort_name: "Name",
    skins_sort_release_new: "Newest",
    skins_sort_release_old: "Oldest",
    skins_section_characters: "Characters",
    skins_section_kinds: "Item kinds",
    skins_kind_body: "Character outfits",
    skins_rarity_modifier_Woven: "Woven",
    skins_rarity_modifier_CharacterModifier: "Character",
    skins_rarity_modifier_Inspired: "Inspired",
    skins_rarity_modifier_Lustrous: "Lustrous",
    rarity_Common: "Common",
    rarity_Classy: "Classy",
    rarity_Spiffy: "Spiffy",
    rarity_Distinguished: "Distinguished",
    rarity_Elegant: "Elegant",
    rarity_Loyal: "Loyal",
    rarity_Timeless: "Timeless",
    rarity_Event: "Event",
    rarity_Reward: "Reward",
    rarity_Character: "Character",
    rarity_ProofOfPurchase: "Proof of Purchase",
    rarity_Resurrected: "Resurrected",
    rarity_Complimentary: "Complimentary",
    rarity_HeirloomClassy: "Heirloom Classy",
    rarity_HeirloomSpiffy: "Heirloom Spiffy",
    rarity_HeirloomDistinguished: "Heirloom Distinguished",
    rarity_HeirloomElegant: "Heirloom Elegant",
    quests_header: "Quest Checklist",
    quests_subheader: "Track Hermit / Fuelweaver / Celestial Champion / Celestial Scion progression. Checks saved only on this device.",
    quests_reset: "Reset",
    quests_reset_confirm: "Reset all checks for this quest?",
    quests_reset_all: "Reset all",
    quests_reset_all_confirm: "Reset all checks across every quest?",
    console_item_spawn: "Item Spawn",
    console_entity_spawn: "Entity Spawn",
    console_search_items: "Search items...",
    console_quantity: "Qty",
    console_copied: "Copied to clipboard",
    console_player: "Player Status",
    console_world: "World Control",
    console_server: "Server Admin",
    console_debug: "Debug",
    console_spawn_mode_give: "Inventory",
    console_spawn_mode_spawn: "At Cursor",
    console_copy_command: "Copy Command",
    console_show_command: "Show Command",
    skills_points: "Learned",
    skills_learn: "Learn",
    skills_unlearn: "Unlearn",
    skills_locked: "Locked",
    skills_reset: "Reset",
    skills_requirements: "Requirements",
    skills_unlocks_items: "Unlocked Items",
    skills_select_character: "Select Character",
    skills_gate_skill_count: "Learn {count} skills to unlock.",
    skills_gate_boss_fuelweaver: "Find and defeat the Ancient Fuelweaver.",
    skills_gate_boss_celestialchampion: "Find and defeat the Celestial Champion.",
    skills_gate_no_shadow: "Have no Shadow Allegiance Skills.",
    skills_gate_no_lunar: "Have no Lunar Allegiance Skills.",
    skills_gate_total_skills: "Learn {count} skills to unlock.",
    game_data_version: "Game Data Source",
    game_data_release: "Release",
    game_data_updated: "Updated",
