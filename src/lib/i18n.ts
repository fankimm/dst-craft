...
const translations = {
  ko: {
    ...
    quests_subheader: "은둔자·대변자·연료직공 진행 상황. 체크는 이 기기에만 저장됩니다.",
    quests_reset: "초기화",
  ...
  en: {
    ...
    quests_subheader: "Track Pearl / Celestial Champion / Fuelweaver progression. Checks saved only on this device.",
    quests_reset: "Reset",
