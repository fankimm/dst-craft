...
const translations = {
  ko: {
    ...
    skins_tags: "태그",
    skins_body_attribution: "캐릭터 본체 스킨 이미지 출처:",
    skins_sort_rarity: "희귀도순",
    skins_sort_name: "이름순",
    skins_sort_release_new: "최신순",
    skins_sort_release_old: "오래된순",
    skins_sort_aria: "정렬 방식",
    skins_filter_active: "필터 {n}개",
  ...
  en: {
    ...
    skins_tags: "Tags",
    skins_body_attribution: "Character body skin images sourced from",
    skins_sort_rarity: "Rarity",
    skins_sort_name: "Name",
    skins_sort_release_new: "Newest",
    skins_sort_release_old: "Oldest",
    skins_sort_aria: "Sort by",
    skins_filter_active: "{n} filter(s)",
